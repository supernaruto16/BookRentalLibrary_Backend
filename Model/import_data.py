...
ratings_json_path = os.getcwd() + '/data/ratings.json'
book_categories_json_path = os.getcwd() + '/data/book_categories.json'
books_json_path = os.getcwd() + '/data/books13.json'
authors_json_path = os.getcwd() + '/data/authors.json'
categories_json_path = os.getcwd() + '/data/categories.json'
